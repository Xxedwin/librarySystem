...
<p class="help-block">La contrase&ntilde;a solo se modificara si escribes algo</p>
    </div>
  </div>

  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label" >Usuario Autorizado</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label" >Usuario Administrador</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
